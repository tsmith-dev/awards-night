...
class NominationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nomination" do
    assert_difference('Nomination.count') do
      post nominations_url, params: { nomination: { category_id: @nomination.category_id, nominee: @nomination.nominee, show_id: @nomination.show_id } }
    end
  ...
  test "should update nomination" do
    patch nomination_url(@nomination), params: { nomination: { category_id: @nomination.category_id, nominee: @nomination.nominee, show_id: @nomination.show_id } }
