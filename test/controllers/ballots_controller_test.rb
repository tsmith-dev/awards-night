...
class BallotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ballot" do
    assert_difference('Ballot.count') do
      post ballots_url, params: { ballot: { references: @ballot.references, references: @ballot.references } }
    end
  ...
  test "should update ballot" do
    patch ballot_url(@ballot), params: { ballot: { references: @ballot.references, references: @ballot.references } }
